  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      await login({
        ...
        name: backendUser.name || "Super Admin",
...
const styles = StyleSheet.create({
  ...
  glowTop: { position: "absolute", top: -80, right: -60, width: 210, height: 210, borderRadius: 105, backgroundColor: "rgba(16,185,129,0.18)" },
  glowBottom: { position: "absolute", bottom: 50, left: -90, width: 230, height: 230, borderRadius: 115, backgroundColor: "rgba(34,197,94,0.12)" },
  content: { flexGrow: 1, paddingHorizontal: 20 },
  topBar: { minHeight: 46, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  backBtn: { width: 42, height: 42, borderRadius: 21, backgroundColor: "rgba(255,255,255,0.12)", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  secureBadge: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "rgba(255,255,255,0.10)", borderRadius: 999, paddingHorizontal: 13, paddingVertical: 9, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  liveDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: "#6EE7B7" },
  secureBadgeText: { fontSize: 10, color: "#ECFDF5", fontFamily: "Inter_800ExtraBold", letterSpacing: 1 },
  hero: { alignItems: "center", paddingTop: 45, paddingBottom: 24 },
  adminMarkOuter: { width: 96, height: 96, borderRadius: 48, backgroundColor: "rgba(255,255,255,0.10)", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", marginBottom: 18 },
  adminMark: { width: 76, height: 76, borderRadius: 38, backgroundColor: "white", alignItems: "center", justifyContent: "center", shadowColor: "#000", shadowOpacity: 0.24, shadowRadius: 16, shadowOffset: { width: 0, height: 8 }, elevation: 10 },
  kicker: { fontSize: 11, color: "#A7F3D0", fontFamily: "Inter_800ExtraBold", letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 7 },
  title: { fontSize: 30, color: "white", fontFamily: "Inter_800ExtraBold", fontWeight: "900", letterSpacing: -0.7, textAlign: "center" },
  subtitle: { marginTop: 9, fontSize: 13, lineHeight: 20, color: "rgba(236,253,245,0.74)", fontFamily: "Inter_400Regular", textAlign: "center", paddingHorizontal: 6 },
  securityPanel: { backgroundColor: "white", borderRadius: 30, padding: 18, shadowColor: "#000", shadowOpacity: 0.18, shadowRadius: 20, shadowOffset: { width: 0, height: 10 }, elevation: 12 },
  panelHeader: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: 12, marginBottom: 18 },
  panelTitle: { fontSize: 20, color: "#0F172A", fontFamily: "Inter_800ExtraBold", fontWeight: "900", letterSpacing: -0.35 },
  panelSub: { marginTop: 3, fontSize: 12, color: "#64748B", fontFamily: "Inter_400Regular" },
  panelIcon: { width: 42, height: 42, borderRadius: 16, backgroundColor: "#ECFDF5", alignItems: "center", justifyContent: "center" },
  inputBlock: { marginBottom: 14 },
  label: { fontSize: 12, color: "#334155", fontFamily: "Inter_800ExtraBold", marginBottom: 8 },
  inputShell: { minHeight: 54, borderRadius: 18, borderWidth: 1, borderColor: "#E2E8F0", backgroundColor: "#F8FAFC", paddingHorizontal: 12, flexDirection: "row", alignItems: "center", gap: 10 },
  inputPrefix: { minWidth: 36, height: 30, borderRadius: 12, backgroundColor: "white", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#E2E8F0" },
  inputPrefixText: { fontSize: 12, color: "#475569", fontFamily: "Inter_800ExtraBold" },
  input: { flex: 1, minWidth: 0, fontSize: 15, color: "#0F172A", fontFamily: "Inter_600SemiBold", paddingVertical: 0 },
  statusBox: { marginTop: 2, borderRadius: 20, padding: 13, flexDirection: "row", alignItems: "center", gap: 11, borderWidth: 1 },
  statusBoxSuccess: { backgroundColor: "#ECFDF5", borderColor: "#A7F3D0" },
  statusBoxNeutral: { backgroundColor: "#FFFBEB", borderColor: "#FDE68A" },
  statusIcon: { width: 38, height: 38, borderRadius: 14, alignItems: "center", justifyContent: "center" },
  statusTitle: { fontSize: 13, color: "#0F172A", fontFamily: "Inter_800ExtraBold", fontWeight: "900" },
  statusText: { marginTop: 2, fontSize: 11, color: "#64748B", fontFamily: "Inter_400Regular", lineHeight: 16 },
  primaryBtn: { marginTop: 18, borderRadius: 20, overflow: "hidden", shadowColor: "#047857", shadowOpacity: 0.18, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 6 },
  disabledBtn: { opacity: 0.72 },
  primaryGradient: { minHeight: 54, borderRadius: 20, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9, paddingHorizontal: 16 },
  primaryBtnText: { color: "white", fontSize: 14, fontFamily: "Inter_800ExtraBold", fontWeight: "900" },
  changeText: { textAlign: "center", marginTop: 12, color: "#047857", fontSize: 13, fontFamily: "Inter_800ExtraBold" },
  rulesCard: { marginTop: 16, borderRadius: 22, padding: 15, backgroundColor: "rgba(15,23,42,0.36)", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  rulesHeader: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 7 },
  rulesTitle: { fontSize: 12, color: "#FEF3C7", fontFamily: "Inter_800ExtraBold", letterSpacing: 0.4 },
  rulesText: { fontSize: 11, lineHeight: 17, color: "rgba(236,253,245,0.68)", fontFamily: "Inter_400Regular" },
  footer: { marginTop: "auto", paddingTop: 28, textAlign: "center", fontSize: 10, color: "rgba(236,253,245,0.42)", fontFamily: "Inter_600SemiBold", letterSpacing: 2 },
  noticeOverlay: { flex: 1, backgroundColor: "rgba(15,23,42,0.48)", alignItems: "center", justifyContent: "center", padding: 22 },
  ...
  noticeTitle: { fontSize: 18, color: "#0F172A", fontFamily: "Inter_800ExtraBold", fontWeight: "900", textAlign: "center" },
  ...
  noticeOkText: { fontSize: 13, color: "white", fontFamily: "Inter_800ExtraBold" },
});
