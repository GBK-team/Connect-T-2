...
const usefulLinks = [
  {
    label: "AMC Official Website",
    url: "https://ambernathmc.org",
    icon: "globe" as const,
  },
  {
    label: "Maharashtra Govt Portal",
...
export default function ProfileScreen() {
    ...
    return (
      <View style={styles.root}>
        ...
        >
          ...
          <Text
            style={[styles.userName, { textAlign: "center", marginTop: 14 }]}
          >
            Welcome to Connect T
          </Text>
          <Text
            style={{
              fontSize: 13,
  ...
  const rc =
    roleConfig[user.role as keyof typeof roleConfig] || roleConfig.citizen;
  ...
  const pickPhoto = async () => {
    if (Platform.OS !== "web") {
      ...
      if (status !== "granted") {
        Alert.alert(
          "Permission needed",
          "Please allow photo library access to set your profile photo.",
        );
        return;
      }
    }
    ...
    <View style={styles.root}>
      ...
      >
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoChipRow}>
                ...
                <Text style={styles.infoChipText}>
                  {user.ward || "Ward 1 — Shivaji Chowk"}
                </Text>
              </View>
              <View style={styles.infoChipRow}>
                <Feather
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statItem}>
            <Text style={[styles.statNum, { color: "#FDE68A" }]}>
              {activeCount}
            </Text>
          ...
          <View style={styles.statDiv} />
          <View style={styles.statItem}>
            <Text style={[styles.statNum, { color: "#6EE7B7" }]}>
              {resolvedCount}
            </Text>
      ...
      >
            ...
            {[
              {
                ...
                label: "My Complaints",
                sub: "View and track all complaints",
                color: "#EA580C",
                bg: "#FFF7ED",
              ...
              },
              {
                icon: "rss" as const,
                label: "News Feed",
                sub: "Ward updates & announcements",
                color: "#7C3AED",
                bg: "#F5F3FF",
              ...
              },
              {
                ...
                label: "Emergency",
                sub: "Quick access to help numbers",
                color: "#DC2626",
                bg: "#FEE2E2",
          ...
          <View style={styles.card}>
            {[
              ...
              },
              {
                ...
                label: "Ward",
                value: user.ward || "Ward 1 — Shivaji Chowk",
              },
              {
                icon: "shield" as const,
                label: "Role",
                value: rc.label + " · " + rc.subLabel,
              },
            ].map((item, idx, arr) => (
              <View
                key={item.label}
        ...
        <View style={styles.appInfoCard}>
          ...
          <Text style={styles.appInfoVersion}>v1.0 · Latest Version</Text>
        </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalSheet, { paddingBottom: 28 }]}>
            ...
            <TouchableOpacity
              onPress={pickPhoto}
              activeOpacity={0.85}
              style={styles.photoEditRow}
            >
              {user.profilePhoto ? (
                <Image
                  source={{ uri: user.profilePhoto }}
                  style={styles.photoEditThumb}
                />
              ) : (
                <View
                  style={[
                    styles.photoEditThumb,
                    {
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.photoEditSub}>
                  Tap to change from gallery
                </Text>
              </View>
            ...
            <View style={styles.fieldGroup}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (!user.wardChanged) setShowWardPicker(true);
                }}
              ...
              <Text
                style={{
                  fontSize: 11,
                  color: user.wardChanged ? "#94A3B8" : "#64748B",
                  fontFamily: "Inter_400Regular",
                  marginTop: 6,
                  lineHeight: 15,
                }}
      ...
      >
        <View style={styles.modalOverlay}>
          <View
            style={[styles.modalSheet, { maxHeight: "75%", paddingBottom: 20 }]}
          >
            <View style={styles.modalHandle} />
            <View
              style={{
            ...
            >
              {ambernathWards.map((ward) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.wardOption,
                    editWard === ward && styles.wardOptionActive,
                  ]}
                  onPress={() => {
                    setEditWard(ward);
                  ...
                  <View style={{ flex: 1 }}>
                    <Text
                      style={[
                        ...
                        language === opt.code && { color: "#EA580C" },
                      ]}
                    >
                      {opt.nativeLabel}
                    </Text>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalSheet}>
            <View
              style={[styles.modalIconWrap, { backgroundColor: "#FEE2E2" }]}
            >
              <Feather name="log-out" size={28} color="#DC2626" />
            </View>
            <Text style={styles.modalTitle}>Logout</Text>
            <Text style={styles.modalBody}>
              Are you sure you want to logout from Connect T?
            </Text>
