...
function SectionHeader({ title, sub }: { title: string; sub?: string }) {
  return (
    <View style={{ marginBottom: 10, marginTop: 6 }}>
      <Text
        style={{ fontSize: 15, fontFamily: "Inter_700Bold", color: "#0F172A" }}
      >
        {title}
      </Text>
      {sub && (
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View
          style={{
            backgroundColor: job.active ? "#D1FAE5" : "#F1F5F9",
            paddingHorizontal: 8,
            paddingVertical: 3,
            borderRadius: 8,
          }}
        >
          <Text
            style={{
              fontSize: 9,
              fontFamily: "Inter_600SemiBold",
              color: job.active ? "#059669" : "#94A3B8",
            }}
          >
      ...
      <View style={{ flexDirection: "row", gap: 6 }}>
        {[
          ...
          {
            label: "Shortlisted",
            value: job.shortlisted?.length || 0,
            color: "#D97706",
            bg: "#FEF3C7",
          },
          {
            label: "Hired",
            value: job.hired?.length || 0,
            color: "#059669",
            bg: "#D1FAE5",
          },
          {
    ...
    >
      ...
      >
        ...
        {[
          ...
          {
            label: "Category",
            value: JOB_CATEGORIES[job.category] || job.category,
            icon: "tag",
          },
...
export default function JobsAdminScreen() {
    ...
    AsyncStorage.getItem("janseva_users").then((raw) => {
      if (raw) {
        try {
          ...
          setTotalCitizens(u.filter((u: any) => u.role === "citizen").length);
        } catch {}
      }
    });
  }, []);
  ...
  const stats = useMemo(() => {
    ...
    const totalSeekers = [...new Set(jobs.flatMap((j) => j.applicants || []))]
      .length;
    const placementRate =
      totalApplications > 0
  ...
  const getModalJobs = useCallback(
    (type: CardType): Job[] => {
      switch (type) {
        case "totalJobs":
          return [...jobs].sort(
        ...
        case "hired":
          return [...jobs]
            .filter((j) => j.hired?.length > 0)
            .sort((a, b) => (b.hired?.length || 0) - (a.hired?.length || 0));
        default:
          return [];
      }
    },
  ...
  const openModal = useCallback(
    (type: CardType, title: string, sub: string) => {
      setSelectedJob(null);
    ...
    <View style={{ flex: 1, backgroundColor: "#F0F4F8" }}>
      ...
      >
        ...
        >
          {[
            ...
            { label: "Hired", value: stats.totalHired, color: "#C4B5FD" },
          ].map((s, i) => (
        ...
        {(["overview", "analytics", "employers"] as const).map((tab) => (
          <TouchableOpacity
            ...
            style={{
              ...
              paddingVertical: 9,
              borderRadius: 10,
              backgroundColor: activeTab === tab ? "#16A34A" : "#F1F5F9",
              alignItems: "center",
            }}
            activeOpacity={0.8}
          >
      ...
      >
        {activeTab === "overview" && (
          <>
            <SectionHeader
              title="Job Portal Overview"
              sub="Tap any card to view full data"
            />
            <View
              style={{
                flexDirection: "row",
              ...
              <StatCard
                ...
                onPress={() =>
                  openModal(
                    "activeJobs",
                    "Active Jobs",
                    `${stats.activeJobs.length} currently active`,
                  )
                }
              />
              <StatCard
                ...
                value={stats.expiredJobs.length}
                color="#DC2626"
                bg="#FEE2E2"
                onPress={() =>
                  openModal(
                    "expiredJobs",
                    "Expired / Paused",
                    `${stats.expiredJobs.length} inactive`,
                  )
                }
              />
              <StatCard
                ...
                onPress={() =>
                  openModal(
                    "employers",
                    "Employers",
                    `${stats.totalEmployers} employers`,
                  )
                }
              />
              <StatCard
                ...
                onPress={() =>
                  openModal(
                    "seekers",
                    "Job Seekers",
                    `${stats.totalSeekers} unique applicants`,
                  )
                }
              />
              <StatCard
              ...
              <StatCard
                ...
                onPress={() =>
                  openModal(
                    "hired",
                    "People Hired",
                    `${stats.totalHired} successfully hired`,
                  )
                }
              />
              <StatCard
            ...
            <View style={{ marginTop: 16 }}>
              <SectionHeader
                ...
                sub="Total registered users on the platform"
              />
              <View
                style={{
                  backgroundColor: "white",
        ...
        {activeTab === "analytics" && (
          <>
            <SectionHeader
              title="Job Success Analytics"
              sub="Hiring outcomes and placement data"
            />
            <View
              style={{
                backgroundColor: "white",
            ...
            >
              ...
              >
                {stats.totalHired} hired from {stats.totalApplications}{" "}
                applications
              </Text>
            </View>
        ...
        {activeTab === "employers" && (
          <>
            <SectionHeader
              ...
              sub="Verify, manage and monitor employers"
            />
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {employer.company?.charAt(0)?.toUpperCase() || "E"}
                      </Text>
                    </View>
                    <View style={{ flex: 1 }}>
                      <Text
            ...
            {selectedJob ? (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {item.company?.charAt(0)?.toUpperCase() || "E"}
                        </Text>
                      </View>
                      <View style={{ flex: 1 }}>
                        <Text
              ...
              <FlatList
                ...
                ListHeaderComponent={
                  ...
                  >
                    ...
                    <View style={{ marginLeft: 12 }}>
                      ...
                      >
                        Unique job seekers who applied
                      </Text>
                    </View>
                  </View>
                }
                renderItem={({ item: seekerId, index }) => {
                  const appliedJobs = jobs.filter((j) =>
                    j.applicants?.includes(seekerId),
                  );
                  const hiredJobs = jobs.filter((j) =>
                    j.hired?.includes(seekerId),
                  );
                  return (
                    <View
                      style={{
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={{ flex: 1 }}>
                          ...
                          >
                            Applied to {appliedJobs.length} job
                            {appliedJobs.length !== 1 ? "s" : ""}
                            {hiredJobs.length > 0
                              ? ` · Hired in ${hiredJobs.length}`
                              : ""}
                          </Text>
                        </View>
                        {hiredJobs.length > 0 && (
              ...
              >
                ...
                >
                  ...
                  <View
                    style={{ flexDirection: "row", gap: 24, marginTop: 12 }}
                  >
                    ...
                    topHiredCategories.map(([cat, count], idx) => (
                      <View
                        ...
                        style={{
                          paddingVertical: 10,
                          borderBottomWidth:
                            idx < topHiredCategories.length - 1 ? 1 : 0,
