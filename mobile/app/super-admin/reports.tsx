...
export default function ReportsScreen() {
  ...
  const officers = NAGARSEVAK_DIRECTORY.filter(
    (n) => n.role === "nagarsevak" && n.wardCode,
  );

  const wardPerformance = officers
    .map((officer) => {
      const wardComplaints = complaints.filter((c) => c.ward === officer.ward);
      const wResolved = wardComplaints.filter(
        (c) => c.status === "resolved",
      ).length;
      const wPending = wardComplaints.filter(
        (c) => c.status === "submitted",
      ).length;
      const wTotal = wardComplaints.length;
      const rate = wTotal > 0 ? Math.round((wResolved / wTotal) * 100) : 0;

      const resolvedComplaints = wardComplaints.filter(
        (c) => c.status === "resolved" && c.updatedAt,
      );
            ...
            >
              ...
              <View style={{ flexDirection: "row", gap: 10 }}>
                ...
                >
                  ...
                  >
                    {avgResolutionOverall != null
                      ? `${avgResolutionOverall}h`
                      : "N/A"}
                  </Text>
                  <Text
                    style={{
                  ...
                  (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {wTotal} total · {wPending} pending · {wResolved}{" "}
                          resolved
                        </Text>
              ...
              {topIssueAreas.length === 0 ? (
                ...
                topIssueAreas.map(([ward, count], idx) => (
                  <View
                    ...
                    style={{
                      paddingVertical: 10,
                      borderBottomWidth: idx < topIssueAreas.length - 1 ? 1 : 0,
                      ...
                      >
                        ...
                        <Text
                          style={{
                            fontSize: 12,
                            fontFamily: "Inter_700Bold",
                            color: catRate >= 50 ? "#059669" : "#D97706",
                          }}
                        >
                          {catRate}% resolved
                        </Text>
            ...
            >
              ...
              >
                ...
                <View style={{ marginLeft: 10 }}>
                  ...
                  >
                    +91 8554994735 · Head Administrator
                  </Text>
                </View>
              </View>
              {sessionLog.map((log, idx) => (
                <View
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    paddingVertical: 10,
                    borderBottomWidth: idx < sessionLog.length - 1 ? 1 : 0,
                    borderBottomColor: "#F1F5F9",
                  }}
                >
                  <View
            ...
            >
              ...
              >
                ...
                <View style={{ marginLeft: 12 }}>
                  ...
                  >
                    System is secure · Auto-scan active
                  </Text>
                </View>
              </View>
              {[
                {
                  label: "Duplicate Complaints Flagged",
                  value: "0",
                  icon: "copy",
                  color: "#16A34A",
                },
