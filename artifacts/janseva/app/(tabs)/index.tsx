...
const alertsAndNews = [
  { id: "1", type: "alert", icon: "alert-triangle", color: "#DC2626", bg: "#FEE2E2", title: "Water Supply Restricted", body: "Station Area East: Supply from 8AM–2PM only today. Store water in advance.", detail: "Due to maintenance work on the Barvi Dam main distribution pipeline near Station Area East, water supply will be restricted from 8AM to 2PM today (27-Apr-2025). Residents are advised to store water in advance. The AMC Water Department is working to restore full supply by evening. Tanker requests: AMC helpline 0251-2604100.", source: "AMC Water Dept.", date: "27 Apr 2025", time: "2h ago" },
  { id: "2", type: "news", icon: "info", color: "#EA580C", bg: "#FFEDD5", title: "Road Repair Notice", body: "Shivaji Chowk to Station Road repair from 26-Apr to 30-Apr. Expect delays.", detail: "The AMC Roads Division has started repair and resurfacing work on Station Road, Ambernath (from Ambernath Junction to Shivaji Chowk Market). Work will continue from 26-Apr to 30-Apr 2025. Heavy vehicles are restricted during 9AM-6PM. Commuters are advised to use alternate routes via Old Ambernath Road. Cost: Rs 45 Lakhs under the Smart City Mission.", source: "AMC Roads Division", date: "25 Apr 2025", time: "5h ago" },
  { id: "3", type: "alert", icon: "zap", color: "#D97706", bg: "#FEF3C7", title: "Planned Power Cut", body: "MIDC Area & Vithalwadi: 10AM–4PM on 27-Apr for transformer upgrade.", detail: "MSEDCL has scheduled a planned power outage in MIDC Area and Vithalwadi on 27-Apr-2025 from 10AM to 4PM for upgrading the 132KV transformer at Ambernath substation. This upgrade will improve power supply reliability for over 12,000 households. Hospitals and emergency services will have backup arrangements. For updates, call MSEDCL helpline 1912.", source: "MSEDCL Ambernath", date: "26 Apr 2025", time: "Yesterday" },
  { id: "4", type: "news", icon: "calendar", color: "#059669", bg: "#D1FAE5", title: "Cleanliness Drive", body: "AMC Swachh Ambernath drive this Sunday 7AM — Shivaji Chowk Municipal Ground.", detail: "AMC is organizing a Swachh Ambernath Cleanliness Drive this Sunday (28-Apr-2025) starting at 7AM from Shivaji Chowk Municipal Ground. All citizens are invited to participate. Free gloves, masks, and cleaning equipment will be provided. Nagarsevaks from all 14 wards will lead teams. Refreshments will be served. Special awards for the cleanest ward will be announced. Register at the AMC office or call 0251-2604100.", source: "AMC Swachh Bharat Cell", date: "25 Apr 2025", time: "1d ago" },
  { id: "5", type: "alert", icon: "cloud-drizzle", color: "#7C3AED", bg: "#EDE9FE", title: "Heavy Rain Warning", body: "IMD: Orange alert for Thane district on 28-Apr. Avoid low-lying areas.", detail: "The India Meteorological Department (IMD) has issued an Orange Alert for Thane district including Ambernath on 28-Apr-2025. Heavy to very heavy rainfall (115-204 mm) is expected. Citizens in low-lying areas near Ulhas River and Chikhloli Dam area are advised to stay alert. NDRF teams are on standby. Avoid waterlogged roads. Emergency helplines: AMC Control Room 0251-2604100, Fire Brigade 101, Police 100.", source: "IMD Mumbai & AMC Disaster Cell", date: "27 Apr 2025", time: "3h ago" },
];
